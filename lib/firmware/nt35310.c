...
void tft_hard_init(void)
{
    init_dcx();
    pin_mux_init();
    spi_config(SPI_CHANNEL, SPI_WORK_MODE_2, SPI_FF_OCTAL, 8);
}
...
{
    set_dcx_data();
    spi_config(SPI_CHANNEL, SPI_WORK_MODE_2, SPI_FF_OCTAL, 16);
...
{
    set_dcx_data();
    spi_config(SPI_CHANNEL, SPI_WORK_MODE_2, SPI_FF_OCTAL, 32);
