...
{
    reculock_t *reculock = get_free_reculock();
    if(reculock == NULL)
    {
        return NULL;
    }
...
{
    lock_lock(lock);
    reculock_t *reculock = get_reculock(lock);
    if(reculock)
    {
        *reculock = (reculock_t)
        {
