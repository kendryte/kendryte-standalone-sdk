...
// typedef enum { i2c_0 = 0; i2c_1; i2c_2; }
// i2c_device_number_t;

void maix_i2c_init(i2c_device_number_t i2c_num, uint32_t address_width,
                   uint32_t i2c_clk);
int maix_i2c_send_data(i2c_device_number_t i2c_num, uint32_t slave_address,
                       const uint8_t *send_buf, size_t send_buf_len,
                       uint16_t timeout_ms);
int maix_i2c_recv_data(i2c_device_number_t i2c_num, uint32_t slave_address,
                       const uint8_t *send_buf, size_t send_buf_len,
